            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <a href="{{ route('formbuilder::forms.index') }}" class="btn btn-sm btn-primary float-md-right">
                            <i class="fa fa-arrow-left"></i> Mes formulaires
                        </a>
                    </h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name" class="col-form-label">Nom du formulaire</label>

                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus placeholder="Entrer le nom de votre formulaire">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="visibility" class="col-form-label">Type de formulaire</label>

                                    <select name="visibility" id="visibility" class="form-control" required="required">
                                        <option value="PRIVATE" selected>PRIVE</option>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-info" role="alert">
                                    ...
                                    Cliquer ou faites un glisser-déposer des composantes dans la zone reservée pour construire votre formulaire
                ...
                <div class="card-footer" id="fb-editor-footer" style="display: none;">
                    <button type="button" class="btn btn-primary fb-clear-btn">
                        <i class="fa fa-remove"></i> Vider le formulaire 
                    </button> 
                    <button type="button" class="btn btn-primary fb-save-btn">
                        <i class="fa fa-save"></i> Envoyer &amp; Enregisstrer
                    </button>
                </div>
            </div>
        </div>
